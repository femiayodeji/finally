...
**Plans**: 6 plans
Plans:
- [ ] 01-01-PLAN.md — Backend foundation: SQLite schema/init/seed + app/main.py wiring + health + static serving
- [ ] 01-02-PLAN.md — Market-data cache extensions: session reference price, ~600pt history ring buffer, session_change_percent
- [ ] 01-03-PLAN.md — Frontend scaffold + terminal shell: Next.js static export, Tailwind dark theme, live connection dot, placeholder panels
...
|-------|----------------|--------|-----------|
| 1. Live Market Terminal | 0/6 | Not started | - |
