...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/femiayodeji/sandbox/andela/augmented-engineering/finally/.claude/.gsd-surface.json`
(sibling to `/home/femiayodeji/sandbox/andela/augmented-engineering/finally/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/femiayodeji/sandbox/andela/augmented-engineering/finally/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/femiayodeji/sandbox/andela/augmented-engineering/finally/.claude/skills`).
...
`/home/femiayodeji/sandbox/andela/augmented-engineering/finally/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/femiayodeji/sandbox/andela/augmented-engineering/finally/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/femiayodeji/sandbox/andela/augmented-engineering/finally/.claude/.gsd-surface.json`
Install profile marker: `/home/femiayodeji/sandbox/andela/augmented-engineering/finally/.claude/.gsd-profile`
Skill dirs: `/home/femiayodeji/sandbox/andela/augmented-engineering/finally/.claude/skills/gsd-*/`
Engine module: `/home/femiayodeji/sandbox/andela/augmented-engineering/finally/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/femiayodeji/sandbox/andela/augmented-engineering/finally/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
