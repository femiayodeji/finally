...
**Verification depth scales with `asvs_level`** (see @/home/femiayodeji/sandbox/andela/augmented-engineering/finally/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
