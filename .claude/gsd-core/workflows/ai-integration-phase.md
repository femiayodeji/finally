...
<required_reading>
@/home/femiayodeji/sandbox/andela/augmented-engineering/finally/.claude/gsd-core/references/ai-frameworks.md
@/home/femiayodeji/sandbox/andela/augmented-engineering/finally/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/femiayodeji/sandbox/andela/augmented-engineering/finally/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/femiayodeji/sandbox/andela/augmented-engineering/finally/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/femiayodeji/sandbox/andela/augmented-engineering/finally/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/femiayodeji/sandbox/andela/augmented-engineering/finally/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/femiayodeji/sandbox/andela/augmented-engineering/finally/.claude/agents/gsd-eval-planner.md for instructions.
