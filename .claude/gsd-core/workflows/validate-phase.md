...
```
Agent(
  prompt="Read /home/femiayodeji/sandbox/andela/augmented-engineering/finally/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/femiayodeji/sandbox/andela/augmented-engineering/finally/.claude/gsd-core/templates/VALIDATION.md`
