...
ones). Reference: @/home/femiayodeji/sandbox/andela/augmented-engineering/finally/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/femiayodeji/sandbox/andela/augmented-engineering/finally/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/femiayodeji/sandbox/andela/augmented-engineering/finally/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/femiayodeji/sandbox/andela/augmented-engineering/finally/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/femiayodeji/sandbox/andela/augmented-engineering/finally/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/femiayodeji/sandbox/andela/augmented-engineering/finally/.claude/gsd-core/templates/spec.md.
