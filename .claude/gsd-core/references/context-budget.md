...
The keys live in `.claude/settings.json` (project) or `/home/femiayodeji/sandbox/andela/augmented-engineering/finally/.claude/settings.json` (global) — **not** in `.planning/config.json`:
